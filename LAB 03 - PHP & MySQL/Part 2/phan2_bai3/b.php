<?php
    ...
    // Processing form data when form is submitted in server side
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        // Validate name
        $input_name = trim($_POST["name"]); // Cut out all blank space, tab, newline... from name
        if (empty($input_name)){
...
<head>
    ...
    <title>phan2|bai 3|Add new Product</title>
</head>
<body>
    <div class="container p-6">
        <div class="row">
            <h1 class="my-3">ADD NEW PRODUCT</h1>
            <p>Please fill in this form and submit to add new product record to the database.</p>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="py-4" style="text-align: right;">
                    ...
                    <!---Reload age by redirect - Not optimal-->
                    <a href="./b.php" class="btn btn-primary ml-2">Reload</a>
