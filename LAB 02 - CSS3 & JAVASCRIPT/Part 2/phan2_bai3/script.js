function submit() {
    ...
    if (!email.match(reg)) return alert("Invalid email address!");
    ...
    if (dd == "dd" || mm == "mm" || yyyy == "yyyy") return alert("Please choose your birthday!");
    if ((mm == "2" && (dd == "30" || dd == "31")) ||
        ((mm == "4" || mm == "6" || mm == "9" || mm == "11") && dd == "31")) return alert("Invalid birthday");
    ...
    if (flag == false) return alert("Please choose your gender!");

    var country = document.getElementById("country").value;
    if (country == "Choose country") return alert("Please choose your Country!");

    var about = document.getElementById("about").value;
    if (about.length == 0) return alert("Please fill in About section!")
    if (about.length > 10000) return alert("The About section contains maximum of 10,000 characters!");
